...
func entryFilterProperties() map[string]interface{} {
	return map[string]interface{}{
		...
		"published_after":  map[string]interface{}{"type": "integer", "minimum": 0, "description": "Return entries published after this Unix timestamp"},
		"published_before": map[string]interface{}{"type": "integer", "minimum": 0, "description": "Return entries published before this Unix timestamp"},
		"changed_after":    map[string]interface{}{"type": "integer", "minimum": 0, "description": "Return entries changed after this Unix timestamp"},
		"changed_before":   map[string]interface{}{"type": "integer", "minimum": 0, "description": "Return entries changed before this Unix timestamp"},
